...
// UPower framework root — the directory that contains `upower.js` and `scaffold/`
const UPOWER_ROOT = path.resolve(__dirname, '../..');

// Configuration — paths relative to UPower framework root, not __dirname
const PROMPT_GUIDE_PATH = path.join(UPOWER_ROOT, 'scaffold/prompts/step_guide_prompt.md');
const KNOWLEDGE_BASE_PATH = path.join(UPOWER_ROOT, 'knowledgebase/prompt_tag_database');
